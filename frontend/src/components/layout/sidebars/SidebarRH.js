// RH Sidebar with Employee-style Design
...
const navItems = [
  { name: 'Dashboard', icon: <FaTachometerAlt />, path: '/RH/dashboard' },
  { name: 'Gérer Employés', icon: <FaUsers />, path: '/RH/manage-employees' },
  { name: 'Demandes de Congé', icon: <FaCalendarAlt />, path: '/RH/leave-requests' },
  { name: 'Justificatifs d\'Absence', icon: <FaExclamationCircle />, path: '/RH/absence-justifications' },
  { name: 'Réclamations', icon: <FaExclamationCircle />, path: '/RH/complaint-reviews' },
  { name: 'Gestion de Carrière', icon: <FaBriefcase />, path: '/RH/career-management' },
];
