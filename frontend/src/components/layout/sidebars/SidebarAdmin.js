...
import {
  FaTachometerAlt, FaUsers, FaUserTie, FaCalendarAlt,
  FaExclamationCircle, FaBriefcase, FaBars
} from 'react-icons/fa';

const navItems = [
  { name: 'Dashboard', icon: <FaTachometerAlt />, path: '/admin/dashboard' },
  { name: 'Gérer RH', icon: <FaUserTie />, path: '/admin/manage-rh' },
  { name: 'Gérer Employés', icon: <FaUsers />, path: '/admin/manage-employees' },
  { name: 'Demandes de Congé', icon: <FaCalendarAlt />, path: '/admin/leave-requests' },
  { name: 'Justificatifs d\'Absence', icon: <FaExclamationCircle />, path: '/admin/absence-justifications' },
  { name: 'Réclamations', icon: <FaExclamationCircle />, path: '/admin/complaint-reviews' },
  { name: 'Gestion de Carrière', icon: <FaBriefcase />, path: '/admin/career-management' },
];
